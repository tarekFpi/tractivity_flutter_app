...
class JonEventDetailsScreen extends StatefulWidget {
  const JonEventDetailsScreen({super.key});

  @override
  State<JonEventDetailsScreen> createState() => _JonEventDetailsScreenState();
}

class _JonEventDetailsScreenState extends State<JonEventDetailsScreen> {
  @override
