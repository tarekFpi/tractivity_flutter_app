        ...
        body: Padding(
          ...
          child: SingleChildScrollView(
            child: Obx(
                  ...
                  var joinedVolunteerList = administratorController.retriveSpecificByEventShowList.value?.joinedVolunteer;

                  var hours = administratorController.retriveSpecificByEventShowList.value.report?.hours;

                  var mileage = administratorController.retriveSpecificByEventShowList.value.report?.mileage;
                        ...
                        if( (administratorController.retriveSpecificByEventShowList.value.joinedVolunteer?[i].volunteer?.id==userId) && (administratorController.retriveSpecificByEventShowList.value.joinedVolunteer?[i].workStatus!="complete"))
                          Column(
                            children: [
                              ...
                              if((administratorController.retriveSpecificByEventShowList.value.joinedVolunteer?[i].startInfo?.isStart!=true))
