...
class OrganizationEventdetailsScreen extends StatefulWidget {
  const OrganizationEventdetailsScreen({super.key});

  @override
  State<OrganizationEventdetailsScreen> createState() => _OrganizationEventdetailsScreenState();
}

class _OrganizationEventdetailsScreenState extends State<OrganizationEventdetailsScreen> {
                        ...
                        Row(
                          ...
                          children: [
                            Align(
                              ...
                              GestureDetector(
                                  onTap: (){
                                    homeController.groupIntoEvent(administratorController.retriveSpecificByEventShowList.value.name.toString(),eventId);
                                  },
