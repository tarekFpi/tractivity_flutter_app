...
class OrganizerMissionDetailsScreen extends StatefulWidget {
  const OrganizerMissionDetailsScreen({super.key});

  @override
  State<OrganizerMissionDetailsScreen> createState() => _OrganizerMissionDetailsScreenState();
}
