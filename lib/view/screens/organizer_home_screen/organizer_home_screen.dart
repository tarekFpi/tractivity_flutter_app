    ...
    return LayoutBuilder(builder: (context,constraints){
      ...
      return Scaffold(
        ...
        ListView(
          ...
          if(organizerController.currentIndex.value==0){
            await organizerController.retriveInvitedMissionsShow();
          }

          if(organizerController.currentIndex.value==1){
            await organizerController.retrieveMissionsActive();
            await organizerController.retrieveMissionsInActive();
          }
        }),
